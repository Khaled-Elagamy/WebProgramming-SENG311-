...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LAB7.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LAB7.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LAB7.Models.SalaryInfo", b =>
                {
            ...
            modelBuilder.Entity("LAB7.Models.Employee", b =>
                {
                    b.HasOne("LAB7.Models.Company", "Company")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("LAB7.Models.SalaryInfo", b =>
                {
                    b.HasOne("LAB7.Models.Employee", "Employee")
                        .WithOne("SalaryInfo")
                        .HasForeignKey("LAB7.Models.SalaryInfo", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
